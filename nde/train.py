...
def train_lampe_npe(estimator, features, context, num_epochs=5000, batch_size=50, lr=1e-3, optimizer=torch.optim.Adam, clip=0.1, validation = False, epochs_until_converge = 20):
