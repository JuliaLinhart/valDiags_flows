...
# USAGE:
# >> python figure2_lc2st_neurips2023.py --t_res_ntrain --n_train 100 1000 10000 100000
# >> python figure2_lc2st_neurips2023.py --t_res_ntrain --n_train 100 1000 10000 100000 --power_ntrain
# >> python figure2_lc2st_neurips2023.py --power_ncal --n_cal 100 500 1000 2000 5000 10000
# >> python figure2_lc2st_neurips2023.py --runtime -nt 0 --n_cal 5000 10000 --task slcp
# >> python figure2_lc2st_neurips2023.py --plot

# To test the code locally:
# - create a task folder named "test" with trained npe in `test/npe_100` (for a chosen task)
# - run the following command:
# >> python figure2_lc2st_neurips2023.py --task test --n_train 100 --n_cal 100 --n_eval 100 -nt 2 --<experiment>
...
from plots_lc2st_neurips2023 import plot_sbibm_results_n_train_n_cal
