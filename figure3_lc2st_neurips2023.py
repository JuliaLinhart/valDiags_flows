...
# >> python figure3_lc2st_neurips2023.py --plot --lc2st_interpretability

# To test the code locally:
# - create a task folder named "test" with jrnmm_npe, joint_data and the observation folder
# - run the following command:
# >> python figure3_lc2st_neurips2023.py --test --global_ct --local_ct_gain --n_cal 100 --n_eval 100 -nt 2
...
# from valdiags.lhpd import t_stats_lhpd
from valdiags.test_utils import precompute_t_stats_null
from pathlib import Path
from plots_lc2st_neurips2023 import (
