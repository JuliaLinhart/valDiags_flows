...
def plot_pairgrid_with_groundtruth(posteriors, theta_gt, color_dict, handles, context, n_samples=10000, title=None):
    ...
    plt.legend(handles=handles, prop=font, fontsize=21, title=title, title_fontsize=20, bbox_to_anchor=(1.1,4.5))
