...
def compute_multi_pvalues(
    ...
    r_alpha_learned = learn_multi_local_pit(
        theta,
        x,
        x_obs,
        flow,
    ...
    r_alpha_null_list = learn_multi_local_pit(
        theta,
        x,
        x_obs,
        flow,
